...
**Additional file 2 (.zip):** Figure source data. Machine-readable CSV files underlying Figures 1-5 and Supplementary Figures S1-S8, with a SHA-256 manifest.
