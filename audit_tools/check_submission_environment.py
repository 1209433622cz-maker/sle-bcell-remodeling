#!/usr/bin/env python3
"""Qualify the pinned submission runtime before artifact creation."""
...
def main() -> None:
    ...
    axis.set(title="Submission savefig qualification", xlabel="x", ylabel="sin(x)")
    ...
    document = Document()
    document.add_heading("Submission document qualification", level=1)
    ...
    result = {
        ...
        "status": "PASS_SUBMISSION_RUNTIME" if passed else "HOLD_SUBMISSION_RUNTIME",
    ...
    (output_dir.parent / "SUBMISSION_RUNTIME_STATUS.json").write_text(
