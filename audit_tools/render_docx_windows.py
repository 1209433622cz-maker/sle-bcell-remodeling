...
def _soffice_executable() -> str:
    """Use the console launcher on Windows so conversion is waitable."""
    return "soffice.com" if sys.platform == "win32" else "soffice"


def _profile_uri(path: str) -> str:
    """Return a valid file URI; `file://C:\\...` hangs LibreOffice on Windows."""
