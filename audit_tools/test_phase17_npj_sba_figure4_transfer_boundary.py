...
class Figure4TransferBoundaryTests(unittest.TestCase):
    ...
    def test_root_text_and_supplement_are_locked(self) -> None:
        self.assertEqual(sha256(ROOT / "01_manuscript/Manuscript.md"), sha256(CURRENT / "sources/Manuscript_figure5_regulatory_ceiling.md"))
        self.assertEqual(sha256(ROOT / "01_manuscript/Supplementary_Information.md"), sha256(RUN / "sources/Supplementary_Information_unchanged.md"))
