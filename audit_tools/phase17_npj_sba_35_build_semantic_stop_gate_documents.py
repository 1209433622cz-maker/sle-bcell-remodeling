#!/usr/bin/env python3
"""Build manuscript and Supplementary DOCX files for the scientific stop gate."""
...
def patch_properties(path: Path, subject: str) -> None:
    ...
    document.core_properties.comments = (
        "Scientific stop gate; canonical sources synchronized and S4b redrawn from frozen Source Data; "
...
def main() -> None:
    ...
    manuscript_source = SOURCES / "Manuscript_scientific_stop_gate.md"
    supplement_source = SOURCES / "Supplementary_Information_scientific_stop_gate.md"
    manuscript = OUTPUT / "Manuscript_scientific_stop_gate.docx"
    supplement = OUTPUT / "Supplementary_Information_scientific_stop_gate.docx"
    ...
    patch_properties(manuscript, "Canonical-source and semantic scientific stop gate")
    patch_properties(supplement, "S4b title-only source redraw and semantic scientific stop gate")
    ...
    checks = {
        "manuscript": {
            ...
            "source_label_defined_childhood_wording": "50 eligible cells in the source-label-defined broad-B analogue per donor" in main_text,
            "ambiguous_mapped_cells_wording_absent": "50 mapped cells per donor" not in main_text,
        },
        "supplement": {
    ...
    status = {
        ...
        "status": "PASS_SCIENTIFIC_STOP_GATE_DOCX_BUILT_DUAL_RENDER_REQUIRED",
        ...
        "display_only_redraws": ["Supplementary Figure S4b title"],
    }
