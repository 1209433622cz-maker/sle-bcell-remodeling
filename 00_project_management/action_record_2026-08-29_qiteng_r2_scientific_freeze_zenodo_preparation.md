...
> 后续执行更新：关联草稿 `22151739` 已创建，DOI `10.5281/zenodo.22151739` 已预留，本地行政版主文与三件上传文件已经完成校验。该报告保留当时的准备阶段事实；当前状态及后续边界见 `action_record_2026-08-29_qiteng_r2_zenodo_release_execution.md`。
