...
The same program was higher in the full internal GSE174188 replication contrast (effect 0.856; q=0.00462) and in the prespecified donor-nonoverlap subset (effect 1.086; q=3.61 x 10^-4). Because both analyses originate from the same accession, they are internal replication rather than independent validation.
